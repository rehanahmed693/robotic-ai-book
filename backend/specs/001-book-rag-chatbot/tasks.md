...
- [x] T001 Create project directory structure: backend/src/{models,services,api,core,database,vector_store}
- [x] T002 Create requirements.txt with FastAPI, Qdrant, Neon Postgres, OpenAI/Cohere API, Pydantic, pytest
- [x] T003 Create .env file template with required environment variables
- [x] T004 Initialize git repository and set up .gitignore for Python project
- [x] T005 Set up basic FastAPI application structure in backend/src/api/main.py
- [x] T006 Create configuration module for environment variables in backend/src/core/config.py

## Phase 2: Foundational Components

- [x] T007 Create database connection utilities for Neon Postgres in backend/src/database/connections.py
- [x] T008 Create Qdrant client utilities in backend/src/vector_store/qdrant_client.py
- [x] T009 Define base Pydantic models and schemas in backend/src/models/base.py
- [x] T010 Create middleware for input validation and rate limiting in backend/src/middleware
...
### Models
- [x] T011 [US1] Create Book model in backend/src/models/book.py
- [x] T012 [US1] Create Chunk model in backend/src/models/chunk.py
- [x] T013 [US1] Create Query model in backend/src/models/query.py
- [x] T014 [US1] Create Answer model in backend/src/models/answer.py
- [x] T015 [US1] Create Session model in backend/src/models/session.py

### Services
- [x] T016 [P] [US1] Create BookService for book management in backend/src/services/book_service.py
- [x] T017 [P] [US1] Create RAGService for RAG operations in backend/src/services/rag_service.py
- [x] T018 [P] [US1] Create ChunkService for chunk management in backend/src/services/chunk_service.py
- [x] T019 [P] [US1] Create SessionService for session management in backend/src/services/session_service.py

### API Endpoints
- [x] T020 [P] [US1] Implement /api/v1/chat/start endpoint in backend/src/api/chat_routes.py
- [x] T021 [P] [US1] Implement /api/v1/chat/query endpoint (global mode) in backend/src/api/chat_routes.py
- [x] T022 [P] [US1] Add basic response schema in backend/src/api/schemas.py
- [ ] T023 [US1] Create API tests for User Story 1 in backend/tests/api/test_chat.py

### Integration
- [x] T024 [US1] Create initial book indexing functionality in backend/src/core/book_indexer.py
- [x] T025 [US1] Implement citation tracking in the RAG pipeline in backend/src/services/rag_service.py
- [x] T026 [US1] Setup basic embedding creation using OpenAI/Cohere APIs in backend/src/core/embeddings.py
- [x] T027 [US1] Create vector storage functionality for Qdrant in backend/src/vector_store/chunk_storage.py
