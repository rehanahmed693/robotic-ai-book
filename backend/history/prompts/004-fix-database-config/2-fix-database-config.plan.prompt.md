...
files_yaml:
  ...
  - specs/004-fix-database-config/research.md
  - specs/004-fix-database-config/data-model.md
  - specs/004-fix-database-config/quickstart.md
  - specs/004-fix-database-config/contracts/health-api.md
tests_yaml: []
---
